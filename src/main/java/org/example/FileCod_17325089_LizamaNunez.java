...
public class FileCod_17325089_LizamaNunez extends FileAbs_17325089_LizamaNunez {
    ...
    /**
     * Metodo TDA constructor File Archivo de codigo fuente
     * @param nameFile : String nombre de archivo
     * @param extension : String extension de archivo
     * @param user : String user creador
     * @param fechaCreacion : Date Fecha de creacion
     * @param ubicacion : String ruta ubicacion archivo
     */
